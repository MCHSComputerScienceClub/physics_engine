...
public class ForceSystem extends AbstractSystem {
    ...
    public void act() {
        for (Entity e : entities) {
            ...
            e.getVectorComponent(Component.ComponentType.VELOCITY).add(e.getVectorComponent(Component.ComponentType.ACCELERATION).mult(Constants.TIMESTEP));
            e.getVectorComponent(Component.ComponentType.POSITION).add(e.getVectorComponent(Component.ComponentType.VELOCITY).iMult(Constants.TIMESTEP));
